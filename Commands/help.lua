        ...
        fields = {
          {
            name = "------#|Important|#------",
            value = "**h$signup**"
            .."\nSigns you up for your progress to be registered in RDifacts. ***This is required to gain access to most of RDifacts commands!***"
          ...
          },
          {
            ...
            value = "**h$open, h$o [Requires 1 Capsule and 1 Key]**"
          ...
          {
            name = "------#|Gameplay|#------",
            value = "**h$adventure, h$adv [6 Hr Cooldown]**"
            ...
            .."\n\n**h$dailykey, h$dk [12 Hr Cooldown]**\nGives you a free key to open a treasure box with!"
